 ...
 */
final class Version20200518221141 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE category ADD name VARCHAR(255) NOT NULL, DROP theme_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE category ADD theme_id INT DEFAULT NULL, DROP name');
